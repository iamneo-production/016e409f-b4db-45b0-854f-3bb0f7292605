...
export class OrganizerService {
  private baseUrl = 'https://8080-fafaadedbbaeefabfbcdcacdcffceeecaffac.premiumproject.examly.io/api/organizer'; // Replace with your Spring Boot backend URL
  ...
  getTeams(): Observable<Team[]> {
    return this.http.get<Team[]>(`https://8080-fafaadedbbaeefabfbcdcacdcffceeecaffac.premiumproject.examly.io/api/admin/teams`);
  }
